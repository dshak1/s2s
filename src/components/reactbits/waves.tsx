...
// Pulled from the free React Bits registry (Waves-TS-TW — canvas Perlin-noise
// line grid, zero extra dependencies, no WebGL). Recolored to the steppe
// palette and made non-interactive (pointer-events-none, no cursor dot) so it
// sits as ambient background motion behind a game without stealing taps.
...
export function Waves({
  lineColor = "rgba(255, 216, 79, 0.16)",
